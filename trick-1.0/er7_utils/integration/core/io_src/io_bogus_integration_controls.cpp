 ...
 * /users/agirish/trick_tutorial/trick/trick_source/er7_utils/integration/core/include/bogus_integration_controls.hh
...
#include "/users/agirish/trick_tutorial/trick/trick_source/er7_utils/integration/core/include/bogus_integration_controls.hh"

extern "C" {

ATTRIBUTES attrer7_utils__BogusIntegrationControls[] = {
...
void init_attrer7_utils__BogusIntegrationControls() {
...
void init_attrer7_utils__BogusIntegrationControls_c_intf() {
    er7_utils::init_attrer7_utils__BogusIntegrationControls() ;
}

size_t io_src_sizeof_er7_utils__BogusIntegrationControls() {
    return sizeof(er7_utils::BogusIntegrationControls) ;
}

void* io_src_allocate_er7_utils__BogusIntegrationControls(int num) {
    er7_utils::BogusIntegrationControls* temp = (er7_utils::BogusIntegrationControls*)calloc(num, sizeof(er7_utils::BogusIntegrationControls));
    for (int ii = 0; ii < num; ++ii) {
        new(&temp[ii]) er7_utils::BogusIntegrationControls();
    }
    return (void*)temp;
}

void io_src_destruct_er7_utils__BogusIntegrationControls(void* address __attribute__((unused)), int num __attribute__((unused))) {
    using namespace er7_utils;
    er7_utils::BogusIntegrationControls* temp = (er7_utils::BogusIntegrationControls*)address;
    for (int ii = 0; ii < num; ++ii) {
        temp[ii].~BogusIntegrationControls();
    }
}

void io_src_delete_er7_utils__BogusIntegrationControls(void* address) {
    delete (er7_utils::BogusIntegrationControls*)address;
}

} //extern "C"

struct UnitsMaper7_utils__BogusIntegrationControls {
    UnitsMaper7_utils__BogusIntegrationControls() {
        Trick::UnitsMap* units_map_ptr = Trick::UnitsMap::units_map();
        units_map_ptr->add_param("BogusIntegrationControls_time_scale_factor", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_integ_starttime", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_integ_simdt", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_integ_dyndt", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_integ_time_scale", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_integ_simtime", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_transition_table", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_step_number", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_cycle_stage", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_final_stage", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_number_stages", "1") ;
        units_map_ptr->add_param("BogusIntegrationControls_reset_needed", "1") ;
    }
} umer7_utils__BogusIntegrationControls;
