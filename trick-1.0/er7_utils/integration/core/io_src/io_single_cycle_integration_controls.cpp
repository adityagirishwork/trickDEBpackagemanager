 ...
 * /users/agirish/trick_tutorial/trick/trick_source/er7_utils/integration/core/include/single_cycle_integration_controls.hh
...
#include "/users/agirish/trick_tutorial/trick/trick_source/er7_utils/integration/core/include/single_cycle_integration_controls.hh"

extern "C" {

ATTRIBUTES attrer7_utils__SingleCycleIntegrationControls[] = {
...
void init_attrer7_utils__SingleCycleIntegrationControls() {
...
void init_attrer7_utils__SingleCycleIntegrationControls_c_intf() {
    er7_utils::init_attrer7_utils__SingleCycleIntegrationControls() ;
}

size_t io_src_sizeof_er7_utils__SingleCycleIntegrationControls() {
    return sizeof(er7_utils::SingleCycleIntegrationControls) ;
}

void* io_src_allocate_er7_utils__SingleCycleIntegrationControls(int num) {
    er7_utils::SingleCycleIntegrationControls* temp = (er7_utils::SingleCycleIntegrationControls*)calloc(num, sizeof(er7_utils::SingleCycleIntegrationControls));
    for (int ii = 0; ii < num; ++ii) {
        new(&temp[ii]) er7_utils::SingleCycleIntegrationControls();
    }
    return (void*)temp;
}

void io_src_destruct_er7_utils__SingleCycleIntegrationControls(void* address __attribute__((unused)), int num __attribute__((unused))) {
    using namespace er7_utils;
    er7_utils::SingleCycleIntegrationControls* temp = (er7_utils::SingleCycleIntegrationControls*)address;
    for (int ii = 0; ii < num; ++ii) {
        temp[ii].~SingleCycleIntegrationControls();
    }
}

void io_src_delete_er7_utils__SingleCycleIntegrationControls(void* address) {
    delete (er7_utils::SingleCycleIntegrationControls*)address;
}

} //extern "C"

struct UnitsMaper7_utils__SingleCycleIntegrationControls {
    UnitsMaper7_utils__SingleCycleIntegrationControls() {
        Trick::UnitsMap* units_map_ptr = Trick::UnitsMap::units_map();
        units_map_ptr->add_param("SingleCycleIntegrationControls_time_scale_factor", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_integ_starttime", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_integ_simdt", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_integ_dyndt", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_integ_time_scale", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_integ_simtime", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_transition_table", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_step_number", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_cycle_stage", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_final_stage", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_number_stages", "1") ;
        units_map_ptr->add_param("SingleCycleIntegrationControls_reset_needed", "1") ;
    }
} umer7_utils__SingleCycleIntegrationControls;
