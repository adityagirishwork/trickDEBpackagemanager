...
trick - program to do something

# SYNOPSIS

**trick** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**trick** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **trick** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**trick** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    trick. See **foo.conf**(5) for further details.
...
**trick** provides some return codes, that can be used in scripts:
...
Aditya Girish <aditya.girish@nasa.gov>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Aditya Girish
